...
![felix](https://github.com/hjm79/desktop-tutorial/assets/51636240/41100d50-4a32-4375-9f09-d7fe16cadb88)
...
#### 앨범아트 크기조정, 대한민국 시간형식으로 변경, 날짜 클릭 시 캘린더 앱 실행


<br/>
기존 음악 앨범을 좀 더 키우고 날짜 형식을 대한민국 형식으로 변경했고 **캘린더 클릭 시 캘린더 어플이 열리게 추가**했습니다.

<br/><br/>

<p>$\huge{\rm{\color{#5ad7b7}설정\ - 제어센터\ - 맨\ 아래\ 자동으로\ 메뉴막대\ 가리기\ 및\ 보기를\ 항상으로 }}$</p>

<br/><br/>

**아래 명령어를 복사 후 터미널로 붙여넣기 후 실행 바랍니다.**
...
<img width="608" alt="space" src="https://github.com/hjm79/desktop-tutorial/assets/51636240/08bec5da-16ea-4c97-a5d9-472129c5b2d5">
